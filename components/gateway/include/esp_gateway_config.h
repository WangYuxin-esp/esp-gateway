...
#define GPIO_LED_DONGLE CONFIG_GPIO_LED_DONGLE

#define ESP_MODEM_ENABLE CONFIG_ESP_MODEM_ENABLE
...
#define ESP_GATEWAY_WIFI_DONGLE_USB          CONFIG_WIFI_DONGLE_USB
#define ESP_GATEWAY_WIFI_DONGLE_SPI          CONFIG_WIFI_DONGLE_SPI
#ifdef CONFIG_ENABLE_SOFTAP_FOR_WIFI_CONFIG
#define ENABLE_SOFTAP_FOR_WIFI_CONFIG        CONFIG_ENABLE_SOFTAP_FOR_WIFI_CONFIG
...
#define SOFTAP_SSID                          CONFIG_SOFTAP_SSID
#define SOFTAP_PASSWORD                      CONFIG_SOFTAP_PASSWORD
#endif
